  ...
  return (
    <div className="min-h-screen bg-gray-50/70 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1280px] mx-auto space-y-6">
        {/* Admin Alert Banner */}
        {isAdmin && (
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white rounded-2xl p-4 sm:p-5 shadow-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4 border border-gray-700">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/admin"
                className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#F06800] to-[#f54278] hover:opacity-90 text-white text-xs font-bold transition-all shadow-md"
              >
                Full Admin Portal →
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#F06800] to-[#f54278] hover:opacity-95 text-white font-bold text-sm shadow-md transition-all cursor-pointer flex items-center gap-2"
                >
              ...
              <form onSubmit={handleSaveProduct} className="space-y-5">
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#F06800] to-[#f54278] hover:opacity-95 text-white font-bold text-sm shadow-md transition-all disabled:opacity-50"
                  >
                    {savingProduct
                      ? "Saving..."
                      : modalMode === "create"
