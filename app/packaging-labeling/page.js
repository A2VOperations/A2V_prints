    ...
    <div className="min-h-screen bg-[#FFFBF8] text-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-4">
        <nav className="flex items-center gap-1.5 text-xs font-bold text-slate-500">
          ...
          <span className="text-[#CC3B10] font-extrabold">Packaging & Labeling</span>
        </nav>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-5">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 leading-[1.15] tracking-tight">
                Custom <br />
                <span className="text-[#FF4A17]">Packaging & Labels.</span>
              </h1>
              <p className="text-slate-600 text-xs sm:text-sm lg:text-base leading-relaxed max-w-xl">
                Elevate your product presentation with branded shipping boxes, custom paper bags, waterproof stickers, and food-grade packaging pouches. Premium materials that keep your products secure and unforgettable.
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-xs h-fit sticky top-6">
                ...
                <div className="space-y-2.5">
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.boxes}
                        onChange={() => toggleFilter('boxes')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Corrugated Boxes</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('type', 'boxes')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        ...
                        onChange={() => toggleFilter('bags')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Paper Bags & Totes</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('type', 'bags')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        ...
                        onChange={() => toggleFilter('stickers')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Adhesive Stickers & Labels</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('type', 'stickers')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.pouches}
                        onChange={() => toggleFilter('pouches')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Flexible Pouches</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('type', 'pouches')})</span>
                  </label>
                </div>
              </div>
                ...
                <div className="space-y-2.5">
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.kraft}
                        onChange={() => toggleFilter('kraft')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Eco Kraft Brown Paper</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('material', 'kraft')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.sbs}
                        onChange={() => toggleFilter('sbs')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Virgin White SBS Card</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('material', 'sbs')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        ...
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Waterproof Vinyl Stock</span>
                    </div>
              ...
              <div className="pt-5">
                <h3 className="text-xs font-extrabold text-slate-800 mb-3">Finish Option</h3>
                <div className="space-y-2.5">
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((item) => (
                ...
                >
                  <div>
                    <Link
                      href={`/packaging-labeling/${item.id}`}
                    ...
                    <Link href={`/packaging-labeling/${item.id}`}>
