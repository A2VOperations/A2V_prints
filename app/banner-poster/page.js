    ...
    <div className="min-h-screen bg-[#FFFBF8] text-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-4">
        <nav className="flex items-center gap-1.5 text-xs font-bold text-slate-500">
          ...
          <span className="text-[#CC3B10] font-extrabold">Banner and Poster</span>
        </nav>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-5">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 leading-[1.15] tracking-tight">
                Eye-Catching <br />
                <span className="text-[#FF4A17]">Banners & Posters.</span>
              </h1>
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-xs h-fit sticky top-6">
              ...
              <div className="py-5 border-b border-slate-100">
                <h3 className="text-xs font-extrabold text-slate-800 mb-3">Material</h3>
                <div className="space-y-2.5">
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.vinyl}
                        onChange={() => toggleFilter('vinyl')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Flex / Vinyl Banner</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('material', 'vinyl')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        ...
                        onChange={() => toggleFilter('fabric')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Fabric Cloth</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('material', 'fabric')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.photoPaper}
                        onChange={() => toggleFilter('photoPaper')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>HD Glossy Photo Paper</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('material', 'photoPaper')})</span>
                  </label>
                </div>
              </div>
              ...
              {/* Dimensions Filter */}
              <div className="py-5 border-b border-slate-100">
                <h3 className="text-xs font-extrabold text-slate-800 mb-3">Dimensions</h3>
                <div className="space-y-2.5">
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.size2x3}
                        onChange={() => toggleFilter('size2x3')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Small (2&apos; x 3&apos;)</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('size', '2x3')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.size3x6}
                        onChange={() => toggleFilter('size3x6')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Medium (3&apos; x 6&apos;)</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('size', '3x6')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.size4x8}
                        onChange={() => toggleFilter('size4x8')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Large (4&apos; x 8&apos;)</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('size', '4x8')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.sizeA1A2}
                        onChange={() => toggleFilter('sizeA1A2')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Poster Size (A1 / A2)</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('size', 'a1a2')})</span>
                  </label>
                </div>
              </div>

              {/* Mounting Option Filter */}
              <div className="pt-5">
                <h3 className="text-xs font-extrabold text-slate-800 mb-3">Mounting Option</h3>
                <div className="space-y-2.5">
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        type="checkbox"
                        checked={filters.eyelets}
                        onChange={() => toggleFilter('eyelets')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Eyelets & Grommets</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('mounting', 'eyelets')})</span>
                  </label>
                  ...
                  <label className="flex items-center justify-between text-xs font-semibold text-slate-700 cursor-pointer">
                    <div className="flex items-center gap-2.5">
                      <input
                        ...
                        onChange={() => toggleFilter('stand')}
                        className="w-4 h-4 rounded text-[#CC3B10] focus:ring-[#CC3B10] border-slate-300"
                      />
                      <span>Roll-up / X-Stand</span>
                    </div>
                    <span className="text-slate-400 text-[11px]">({getCount('mounting', 'stand')})</span>
                  </label>
                </div>
              </div>
            </div>
              ...
              {filteredProducts.map((item) => (
                ...
                >
                  <div>
                    ...
                    <Link href={`/banner-poster/${item.id}`}>
