        ...
        <div className="min-h-screen bg-[#FFFBF8] text-slate-800">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-4">
                <nav className="flex items-center gap-1.5 text-xs font-bold text-slate-500">
                    ...
                    <span className="text-[#CC3B10] font-extrabold">Printing Categories</span>
                </nav>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-5">
                            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 leading-[1.15] tracking-tight">
                                ...
                                <span className="text-[#FF4A17]">Printing Catalog.</span>
                            </h1>
                            <p className="text-slate-600 text-xs sm:text-sm lg:text-base leading-relaxed max-w-xl">
                                Premium custom printing solutions that speak volumes before you even say a word. Choose from 8 specialized printing categories and over 60+ custom print solutions crafted for excellence.
                            </p>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`p-3 rounded-xl border text-left transition-all cursor-pointer ${packageTier === tier.id
