...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center bg-gradient-to-br from-slate-50 via-purple-50/30 to-orange-50/30 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-8 sm:p-10 transition-all">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">
            Join A2V Prints to start customizing and ordering premium print products
          </p>
        </div>
