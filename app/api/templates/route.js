...
export async function POST(request) {
  try {
    ...
    const newTemplate = await Template.create({
      ...
      fullDesignSize: body.fullDesignSize || "93.00 mm x 56.00 mm",
      finalCardSize: body.finalCardSize || body.size || "90.00 mm x 53.00 mm",
      safeAreaSize: body.safeAreaSize || "82.00 mm x 45.00 mm",
      size: body.finalCardSize || body.size || "90.00 mm x 53.00 mm",
      bleedArea: body.bleedArea !== undefined ? Number(body.bleedArea) : 1.5,
      safeArea: body.safeArea !== undefined ? Number(body.safeArea) : 5.5,
      bleedSize: body.bleedSize || "1.5mm x 1.5mm",
      safeSize: body.safeSize || "5.5mm x 5.5mm",
      bleedMarginX: body.bleedMarginX !== undefined ? Number(body.bleedMarginX) : 1.5,
      bleedMarginY: body.bleedMarginY !== undefined ? Number(body.bleedMarginY) : 1.5,
      safeMarginX: body.safeMarginX !== undefined ? Number(body.safeMarginX) : 5.5,
      safeMarginY: body.safeMarginY !== undefined ? Number(body.safeMarginY) : 5.5,
